...
void checkPlayer() {
   ...
   cout << "Player's postion: " << player.getPosition() << endl;
   ...
   assert(aPlayer.getPosition() == player.getPosition());
   ...
   cout << "Copied player's postion: " << aPlayer.getPosition() << endl;
   ...
   assert(bPlayer.getPosition() == aPlayer.getPosition());
   ...
   cout << "Player's postion (assignment operator): " << bPlayer.getPosition() << endl;
